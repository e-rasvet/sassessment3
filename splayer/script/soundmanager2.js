    ...
    this._onfinish = function() {
      ...
      if (s.instanceCount) {
        ...
        if (!s.instanceCount || s._iO.multiShotEvents) {
          ...
          if (io_onfinish) {
            var eid = s._a._s._data.oLink.id;
            var pos = eid.indexOf( "play_l_" );
            
            if (pos >= 0) {
              var ids = parseInt(eid.replace(/play_l_/g,""));
              
              $("#questionbox_"+ids).removeClass("activeborder");
              $("#answerbox_"+ids).addClass("activeborderb");
            }
            
            var pos = eid.indexOf( "play_a_" );
            
            if (pos >= 0) {
              var ids = parseInt(eid.replace(/play_a_/g,""));
